...
class ProductModel(models.Model):
    ...
    product_sale_deal = fields.Integer(string="Product Sale Deal",compute="_onchange_sale", store=True)
    ...
    customer_id = fields.Many2one('fashion.customer',string="Customer")
